...
Revision ID: 7a06f72bf1f0
Revises: f2bfeea1d974
Create Date: 2025-12-13 22:40:43.609222
...
revision = '7a06f72bf1f0'
down_revision = 'f2bfeea1d974'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table('chart_projects',
    sa.Column('id', sa.Integer(), nullable=False),
